package curso.alberto.sunriseweatherapp.data.location
...
class GPSTracker(private val mContext: Context) : Service(),
    ...
    fun getLocation() {
        try {
            ...
            if (isGPSEnabled) {
                ...
                Log.println(Log.ASSERT,"","Application use GPS Service")
            ...
            //e.printStackTrace();
            Log.println(Log.ASSERT,"", "Impossible to connect to LocationManager" + e)
        }
    }
    ...
    fun showSettingsAlert() {
        ...
        alertDialog.setTitle("Pedir permisos GPS")

        //Setting Dialog Message
        alertDialog.setMessage("Permite acceder al gps")
