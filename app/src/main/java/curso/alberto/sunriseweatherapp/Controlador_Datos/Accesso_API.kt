...
class Accesso_API {
    ...
    */
    ...
    /*
        Bandera que indica que ya se ha
    */
        ...
        GlobalScope.launch {
            ...
            /*
                ...
                * Se realiza la llamada al endpoint de previccion 12 horas para recoger los
                  siquientes datos:
                    hora_1, temperatura_hora_1, icono_hora_1,
                    hora_2, temperatura_hora_2, icono_hora_2,
                    hora_3, temperatura_hora_3, icono_hora_3,
                    hora_4, temperatura_hora_4, icono_hora_4,
                    hora_5, temperatura_hora_5, icono_hora_5,
            ...
            /*
                A cntinuación se copia los datos necesarios obtenidos de las anteriores llamadas
